...
use PerlFPM qw(addn muln mapp eqto isEven filt zipp zipplist seqApplicationList);
...
my @input_list = (1,2);
my @seqApplicationList_result = seqApplicationList(\@functions_list, \@input_list);
print "[*] seqApplicationList ((addn 1), (muln 2)) (1,2) : (";
print "$_, " for @seqApplicationList_result;
print ")\n";
